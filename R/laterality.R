...
aal_paired_regions <- c("Precentral", "Frontal_Sup", "Frontal_Sup_Orb", 
...
aal3_paired_regions <- c("Precentral", "Frontal_Sup_2", "Frontal_Mid_2", "Frontal_Inf_Oper", 
...
laterality <- function(x, idname = "ID",
  ...
  if (verbose) msg("Calculating laterality index for", 
  ...
  lat <- cbind(data.table(ID = x[, ..idname]), 
